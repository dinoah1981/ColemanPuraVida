...
export default function CostaRicaTrip() {
  ...
  return (
    <div style={{
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                color: "#d6d3d1", padding: "10px 20px", borderRadius: "24px", cursor: "pointer",
                fontSize: "14px", backdropFilter: "blur(10px)", transition: "all 0.25s",
              }}
              onMouseOver={e => { e.currentTarget.style.background = "rgba(255,255,255,0.14)"; e.currentTarget.style.color = "#fafaf9"; }}
              onMouseOut={e => { e.currentTarget.style.background = "rgba(255,255,255,0.07)"; e.currentTarget.style.color = "#d6d3d1"; }}
            >
              {btn.label}
            </button>
          ))}
      ...
      {/* Travelers Panel */}
      {showTravelers && (
        <div className="app-header animate-fade-in-scale" style={{
          margin: "0 auto", padding: "0 24px 16px", maxWidth: "1200px",
        }}>
          <div style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: "10px" }}>
              {TRAVELERS.map((t, i) => (
                <div key={i} className={delayClass(i)} style={{
                  ...
                  background: "rgba(255,255,255,0.05)", fontSize: "15px",
          ...
          <div style={{
            ...
            {Object.entries(PACKING).map(([cat, items]) => (
              <div key={cat} style={{ marginBottom: "20px" }}>
                ...
                {items.map((item, i) => (
                  <div key={i} style={{
                    padding: "8px 0", fontSize: "15px", color: "#d6d3d1",
                    borderBottom: i < items.length - 1 ? "1px solid rgba(255,255,255,0.05)" : "none",
                    display: "flex", alignItems: "center", gap: "10px", lineHeight: 1.5,
                  }}>
                    <span style={{ width: "18px", height: "18px", borderRadius: "5px", border: "1.5px solid rgba(255,255,255,0.2)", display: "inline-block", flexShrink: 0 }} />
                    {item}
                  </div>
                ))}
              </div>
